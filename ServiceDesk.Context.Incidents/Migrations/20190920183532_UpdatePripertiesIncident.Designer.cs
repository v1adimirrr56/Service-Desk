...
namespace ServiceDesk.Context.Incidents.Migrations
{
    ...
    [Migration("20190920183532_UpdatePripertiesIncident")]
    partial class UpdatePripertiesIncident
    {
            ...
            modelBuilder.Entity("ServiceDesk.Incidents.Entities.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2019, 9, 20, 21, 35, 32, 305, DateTimeKind.Local).AddTicks(9771),
                            CreatorName = "Ching Hso-lin",
                            ImpactId = 1L,
                            IsComposite = true,
                            ManagerId = 1L,
                            PassVendorDate = new DateTime(2019, 10, 22, 21, 35, 32, 307, DateTimeKind.Local).AddTicks(714),
                            PhaseId = 1L,
                            PlanDateResolve = new DateTime(2019, 9, 30, 21, 35, 32, 307, DateTimeKind.Local).AddTicks(3298),
                            PriorityId = 1L,
                            Rate = 5.0,
                            ShareType = 0,
                            StateId = 1L,
                        ...
                        new
                        {
                            ...
                            ContactPhone = "+1(137)-691-2995",
                            CreateDate = new DateTime(2019, 9, 20, 21, 35, 32, 307, DateTimeKind.Local).AddTicks(5736),
                            CreatorName = "Ngoma",
                            ImpactId = 2L,
                            IsComposite = false,
                            ManagerId = 2L,
                            PassVendorDate = new DateTime(2019, 10, 13, 21, 35, 32, 307, DateTimeKind.Local).AddTicks(5747),
                            PhaseId = 2L,
                            PlanDateResolve = new DateTime(2019, 10, 6, 21, 35, 32, 307, DateTimeKind.Local).AddTicks(5763),
                            PriorityId = 2L,
                            Rate = 7.0,
                            ShareType = 1,
                            StateId = 2L,
                        ...
                        new
                        {
                            ...
                            ContactPhone = "+1(137)-691-2995",
                            CreateDate = new DateTime(2019, 9, 20, 21, 35, 32, 307, DateTimeKind.Local).AddTicks(5782),
                            CreatorName = "Szegeczowska",
                            ImpactId = 3L,
                            IsComposite = false,
                            ManagerId = 3L,
                            PassVendorDate = new DateTime(2019, 11, 19, 21, 35, 32, 307, DateTimeKind.Local).AddTicks(5783),
                            PhaseId = 3L,
                            PlanDateResolve = new DateTime(2019, 9, 22, 21, 35, 32, 307, DateTimeKind.Local).AddTicks(5784),
                            PriorityId = 3L,
                            Rate = 2.0,
                            ShareType = 0,
                            StateId = 3L,
