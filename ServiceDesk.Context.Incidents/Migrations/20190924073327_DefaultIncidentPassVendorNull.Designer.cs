...
namespace ServiceDesk.Context.Incidents.Migrations
{
    ...
    [Migration("20190924073327_DefaultIncidentPassVendorNull")]
    partial class DefaultIncidentPassVendorNull
    {
            ...
            modelBuilder.Entity("ServiceDesk.Incidents.Entities.Incident", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2019, 9, 24, 7, 33, 26, 748, DateTimeKind.Utc).AddTicks(4326),
                            CreatorName = "Ching Hso-lin",
                            ImpactId = 1L,
                            IsComposite = true,
                            ManagerId = 1L,
                            PassVendorDate = new DateTime(2019, 10, 26, 7, 33, 26, 748, DateTimeKind.Utc).AddTicks(5930),
                            PhaseId = 1L,
                            PlanDateResolve = new DateTime(2019, 10, 4, 7, 33, 26, 748, DateTimeKind.Utc).AddTicks(8344),
                            PriorityId = 1L,
                            Rate = 5.0,
                            ShareType = 0,
                            StateId = 1L,
                        ...
                        new
                        {
                            ...
                            ContactPhone = "+1(137)-691-2995",
                            CreateDate = new DateTime(2019, 9, 24, 7, 33, 26, 749, DateTimeKind.Utc).AddTicks(763),
                            CreatorName = "Ngoma",
                            ImpactId = 2L,
                            IsComposite = false,
                            ManagerId = 2L,
                            PassVendorDate = new DateTime(2019, 10, 17, 7, 33, 26, 749, DateTimeKind.Utc).AddTicks(772),
                            PhaseId = 2L,
                            PlanDateResolve = new DateTime(2019, 10, 10, 7, 33, 26, 749, DateTimeKind.Utc).AddTicks(788),
                            PriorityId = 2L,
                            Rate = 7.0,
                            ShareType = 1,
                            StateId = 2L,
                        ...
                        new
                        {
                            ...
                            ContactPhone = "+1(137)-691-2995",
                            CreateDate = new DateTime(2019, 9, 24, 7, 33, 26, 749, DateTimeKind.Utc).AddTicks(806),
                            CreatorName = "Szegeczowska",
                            ImpactId = 3L,
                            IsComposite = false,
                            ManagerId = 3L,
                            PassVendorDate = new DateTime(2019, 11, 23, 7, 33, 26, 749, DateTimeKind.Utc).AddTicks(807),
                            PhaseId = 3L,
                            PlanDateResolve = new DateTime(2019, 9, 26, 7, 33, 26, 749, DateTimeKind.Utc).AddTicks(808),
                            PriorityId = 3L,
                            Rate = 2.0,
                            ShareType = 0,
                            StateId = 3L,
                        ...
                        new
                        {
                            ...
                            ContactPhone = "+1(137)-691-2995",
                            CreateDate = new DateTime(2019, 9, 24, 7, 33, 26, 749, DateTimeKind.Utc).AddTicks(809),
                            CreatorName = "Hiram Mackenzie",
                            ImpactId = 1L,
                            IsComposite = true,
                            ManagerId = 1L,
                            PassVendorDate = new DateTime(2019, 9, 26, 7, 33, 26, 749, DateTimeKind.Utc).AddTicks(812),
                            PhaseId = 1L,
                            PlanDateResolve = new DateTime(2019, 10, 2, 7, 33, 26, 749, DateTimeKind.Utc).AddTicks(813),
                            PriorityId = 1L,
                            Rate = 5.0,
                            ShareType = 0,
                            StateId = 1L,
